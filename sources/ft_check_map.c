...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/23 11:06:43 by lbaroni           #+#    #+#             */
/*   Updated: 2023/02/23 11:06:47 by lbaroni          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_check_rows(t_game *game)
{
	...
	{
		if ((int) ft_strlen(game->map.full[i]) != game->map.columns + 1)
...
{
	if (game->map.coins == 0)
		ft_error_msg("Invalid Map. There are no Collectibles!", game);
